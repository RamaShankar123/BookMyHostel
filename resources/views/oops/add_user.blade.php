...
<div class="container">
  <div class="row justify-content-md-center">
    ...
    <div class="col col-lg-12" style="background-color: white;border-radius: 10px;padding-left: 5%;padding-right: 5%;padding-top: 2%;padding-bottom: 2%;margin-bottom: 34px;">
      <form method="POST" action="{{url('save-add-user')}}" enctype="multipart/form-data">
  <div class="mb-3">
  ...
  <div class="mb-3">
    ...
    <input type="file" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" name="profile_pick" maxlength="10" required>
  </div>
  <div class="mb-3">
